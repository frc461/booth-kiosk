...
/******/ 	__webpack_require__.p = "../build/public/lib/";
/******/
...
var _handyLib = __webpack_require__(37);

var _handyLib2 = _interopRequireDefault(_handyLib);

var _overlaySrc = __webpack_require__(32);

var _overlaySrc2 = _interopRequireDefault(_overlaySrc);
...
var overlay = new _overlaySrc2.default();
...
handyLib.getPresJson(function (json) {
  var ClickableTile = function (_React$Component) {
    _inherits(ClickableTile, _React$Component);

    function ClickableTile(props) {
      _classCallCheck(this, ClickableTile);

      return _possibleConstructorReturn(this, (ClickableTile.__proto__ || Object.getPrototypeOf(ClickableTile)).call(this, props));
    }

    _createClass(ClickableTile, [{
      key: 'componentDidMount',
      value: function componentDidMount() {
        if ($('.selected').length) {} else {
          $(_reactDom2.default.findDOMNode(this)).find('.card').addClass("selected");
      ...
      value: function render() {
        var elem = _react2.default.createElement(
          ...
          _react2.default.createElement(
            'div',
            { className: 'card', 'data-type': this.props.type, 'data-name': this.props.name, 'data-key': this.props.datakey },
            _react2.default.createElement(
              'div',
  ...
  var HomeTiles = function (_React$Component2) {
    _inherits(HomeTiles, _React$Component2);

    function HomeTiles(props) {
      _classCallCheck(this, HomeTiles);

      return _possibleConstructorReturn(this, (HomeTiles.__proto__ || Object.getPrototypeOf(HomeTiles)).call(this, props));
    }

    _createClass(HomeTiles, [{
      key: 'render',
      value: function render() {
        var tiles = $.map(json['presets'], function (obj, key) {
          return _react2.default.createElement(ClickableTile, { name: obj.name, type: obj.type, datakey: key });
        });
  ...
  _reactDom2.default.render(_react2.default.createElement(HomeTiles, null), $('#mainContainer')[0]);
});
...
var HandyLib = function () {
  function HandyLib() {
    _classCallCheck(this, HandyLib);
  }

  _createClass(HandyLib, [{
    key: "getJsonFile",
    value: function getJsonFile() {
      var root = '/pres/';
...
var _HandyLib = __webpack_require__(29);
...
var Overlay = function () {
  ...
  _createClass(Overlay, [{
    key: 'createOverlay_',
    value: function createOverlay_(direct, length) {
      $('body').append("<div class='overlay hide'></div>");
      $('head').append("<link href='/css/overlay.css' rel='stylesheet' />");
      _reactDom2.default.render(_react2.default.createElement(InactivityCounter, { direct: direct, length: length }), $('.overlay')[0]);
    }
  }, {
    key: 'createOverlayDelay',
    value: function createOverlayDelay(direct, length) {
      this.createOverlay_(direct, length);
    }
  }, {
    key: 'createOverlay',
    value: function createOverlay(direct) {
      this.createOverlay_(direct, 40);
    }
  }, {
    key: 'getNextElement',
    value: function getNextElement(callback) {
...
var InactivityCounter = function (_React$Component) {
  _inherits(InactivityCounter, _React$Component);

  function InactivityCounter(props) {
    _classCallCheck(this, InactivityCounter);

    var _this = _possibleConstructorReturn(this, (InactivityCounter.__proto__ || Object.getPrototypeOf(InactivityCounter)).call(this, props));

    _this.state = { seconds: props.length };
    console.log(props.direct);
    return _this;
  }

  _createClass(InactivityCounter, [{
    key: 'countDown',
    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        'The slide will automatically continue in ',
        this.state.seconds
      );
    }
  }]);

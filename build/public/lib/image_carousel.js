...
$(document).ready(function () {
  handyLib.getPresJson(function (json) {
    var CarouselPictures = function (_React$Component) {
      _inherits(CarouselPictures, _React$Component);

      function CarouselPictures(props) {
        _classCallCheck(this, CarouselPictures);

        return _possibleConstructorReturn(this, (CarouselPictures.__proto__ || Object.getPrototypeOf(CarouselPictures)).call(this, props));
      }

      _createClass(CarouselPictures, [{
        ...
        value: function render() {
          var pictures = json['presets'][handyLib.getKey()]['images'].map(function (picture) {
            return _react2.default.createElement(
              'a',
              { className: 'carousel-item', href: '/docs/images/' + picture },
              _react2.default.createElement('img', { src: '/docs/images/' + picture })
            );
          });
          return _react2.default.createElement(
            'div',
    ...
    _reactDom2.default.render(_react2.default.createElement(CarouselPictures, null), $('#mainContainer')[0]);
  });
});

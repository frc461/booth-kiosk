...
var FullscreenCarousel = function (_React$Component) {
  _inherits(FullscreenCarousel, _React$Component);

  function FullscreenCarousel(props) {
    _classCallCheck(this, FullscreenCarousel);

    return _possibleConstructorReturn(this, (FullscreenCarousel.__proto__ || Object.getPrototypeOf(FullscreenCarousel)).call(this, props));
  }

  _createClass(FullscreenCarousel, [{
    ...
    value: function render() {
      var pictures = this.props.slide_data['presets'][handyLib.getKey()]['images'].map(function (picture) {
        return _react2.default.createElement(
          'li',
          null,
          _react2.default.createElement(
            'a',
            { href: '../assets/images/' + picture },
            _react2.default.createElement('object', { data: '../assets/images/' + picture, style: { 'max-width': '100%', 'max-height': '100%', left: '50%', top: '50%', position: 'fixed', transform: 'translate(-50%, -50%)' }, className: 'center', align: 'middle' })
          )
        );
      });
      return _react2.default.createElement(
...
handyLib.findFilefromKey(handyLib.findGetParameter('media_set'), function (media_set_json_file) {
  handyLib.getJson('media_set/' + media_set_json_file, function (slide_data) {
    _reactDom2.default.render(_react2.default.createElement(FullscreenCarousel, { slide_data: slide_data }), $('#mainContainer')[0]);

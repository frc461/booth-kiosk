...
/******/ 	__webpack_require__.p = "../resources/js/lib/";
/******/
...
var CarouselPictures = function (_React$Component) {
  ...
  _createClass(CarouselPictures, [{
    ...
    value: function render() {
      ...
      var pictures = this.props.slide_data['presets'][this.props.datakey]['images'].map(function (picture) {
        return _react2.default.createElement(
          'a',
          { className: 'carousel-item', href: '../assets/images/' + picture, style: { 'minHeight': '30%', 'minWidth': '30%' } },
          _react2.default.createElement('img', { src: '../assets/images/' + picture, style: { 'minHeight': '30%', 'minWidth': '30%' } })
        );
      });
      return _react2.default.createElement(
        'div',
        { className: 'carousel', style: { 'top': '0', 'left': '0', 'position': 'fixed', 'height': '100%' } },
        pictures
      );
    }
  }]);
...
handyLib.findFilefromKey(handyLib.findGetParameter('media_set'), function (media_set_json_file) {
  handyLib.getJson('media_set/' + media_set_json_file, function (slide_data) {

    _reactDom2.default.render(_react2.default.createElement(CarouselPictures, { slide_data: slide_data, datakey: handyLib.findGetParameter('target') }), $('#mainThing')[0]);

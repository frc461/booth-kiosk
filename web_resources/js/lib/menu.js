    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'div',
          { className: 'card', 'data-key': this.props.datakey },
...
handyLib.findFilefromKey(handyLib.findGetParameter('media_set'), function (media_set_json_file) {
  handyLib.getJson('media_set/' + media_set_json_file, function (data) {
    _reactDom2.default.render(Object.keys(data['presets']).map(function (item) {
      return _react2.default.createElement(MenuItem, { name: data['presets'][item]['name'], datakey: item });
    }), $('#mainThing')[0]);
...
function glowingCard() {
  ...
  $([1, 2, 3, 4, 5, 4, 3, 2, 1]).each(function (i, v) {
    setTimeout(function () {
